...
CREATE TABLE IF NOT EXISTS images (
    ...
    detection_width SMALLINT UNSIGNED NULL COMMENT 'Image width in pixels at which face detection was run',
    detection_height SMALLINT UNSIGNED NULL COMMENT 'Image height in pixels at which face detection was run',
